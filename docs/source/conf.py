...
# b2b_pricing_model documentation build
...
from b2b_pricing_model import __version__ as release

# -- Project information -----------------------------------------------------

project = "b2b_pricing_model"
author = "Kedro"
...
htmlhelp_basename = "b2b_pricing_modeldoc"
...
latex_documents = [
    (
        master_doc,
        "b2b_pricing_model.tex",
        "b2b_pricing_model Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "b2b_pricing_model",
        "Project b2b_pricing_model codebase.",
        "Data-Science",
    )
]
